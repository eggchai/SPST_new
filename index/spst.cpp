...
/* An implementation of top-down splay tree
 If Element is in the tree, then the node containing the Element will be rotated to root,
...
/* Implementation 1:
   First Splay(Element, root)(and assume the tree we get is called *), so root node and
   its left child tree will contain nodes with Elements <= Element, so we could rebuild
...
NOTE: This implementation of splay tree doesn't allow nodes of duplicate Elements!
 */
